...
/*FUNCTION DEFINITION *************************************************************************************************/
static void IRAM_ATTR scheduler_update(void) {
...
void scheduler_init() {
	...
	//set the callback of timer0 ISR to the function scheduler_update
	timer3ESP_setCallback(&scheduler_update);

	//start timer 0 firing every 1 mills
	timer3ESP_start();
}
