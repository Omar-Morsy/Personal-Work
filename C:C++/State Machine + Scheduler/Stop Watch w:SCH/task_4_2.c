...
int main() {
	...
	//Task 1 to toggle red LED every 0.5 second
	...
	//implement task3 using schedulers to toggle yellow led when joystick presssed and turns off after 5s
	...
	//implement task4 using schedulers to start and stops a stop watch by pressing the rotary button
